...
export function JourneySlider() {
  ...
  const baseSlideDuration = Math.max(900, Number(slide.duration || 2600));
  ...
  const slideDuration = slide.fastNotes && noteTimelineDuration > 0 ? Math.max(900, noteTimelineDuration) : Math.max(baseSlideDuration, noteTimelineDuration);
    ...
    <section id="journey" className="journey-section">
      <div className="journey-grid">
        ...
        >
          ...
          {currentSlide === 0 && (
            <div className="journey-opening-prologue" aria-hidden="true">
              <span>Once upon a time.................</span>
              <span>A boy was born in Pidie Jaya, His name........</span>
            </div>
          )}
          ...
          <footer className={`journey-slide-footer ${currentSlide <= 7 ? "journey-slide-footer--early" : ""}`}>
