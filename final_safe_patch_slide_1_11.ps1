# ==========================================================
# FINAL SAFE PATCH - Journey Slider Slide 1-11 Only
...
$backupDir = ".\SAFE_BACKUP_BEFORE_SLIDE_1_11_PATCH_$stamp"
...
const openingBackground = publicAssetUrl([
  "/assets/slide-1/background.png",
  "/assets/slide-1/background.jpg",
  "/assets/slide-1/background.webp"
], "/assets/slide-1/background.png");

const busFrames = [
  publicAssetUrl(["/assets/slide-2/frame-1.png", "/assets/slide-2/frame-1.jpg"], "/assets/slide-2/frame-1.png"),
  publicAssetUrl(["/assets/slide-2/frame-3.png", "/assets/slide-2/frame-3.jpg"], "/assets/slide-2/frame-3.png")
];
...
const newSlides = [
  ...
  },
  {
    ...
    frames: frameSet("slide-3", 4, "slide-3"),
    footerLayout: "single",
    accent: "#16a085",
  ...
  },
  {
    ...
    frames: frameSet("slide-4", 4, "slide-4"),
    footerLayout: "single",
    accent: "#0c8bd8",
  ...
  },
  {
    ...
    frames: frameSet("slide-5", 4, "slide-5"),
    footerLayout: "single",
    accent: "#7b57d1",
  ...
  },
  {
    ...
    frames: frameSet("slide-7", 6, "slide-7"),
    footerLayout: "single",
    accent: "#16a085",
    accentSoft: "rgba(22,160,133,.15)",
    frameLoops: 3,
  ...
  },
  {
    ...
    frames: frameSet("slide-8", 3, "slide-8"),
    footerLayout: "single",
    accent: "#0284c7",
  ...
  },
  {
    ...
    frames: frameSet("slide-9", 4, "slide-9"),
    footerLayout: "single",
    accent: "#f97316",
  ...
  },
  {
    ...
    frames: frameSet("slide-10", 4, "slide-10"),
    footerLayout: "single",
    accent: "#0f172a",
...
$cssMarker = "FINAL-SAFE-SLIDE-1-11-ONLY-PATCH"

$cssAppend = @'
/* ==========================================================
   FINAL-SAFE-SLIDE-1-11-ONLY-PATCH
...
#journey .journey-panel[data-slide-index="0"]::after {
  ...
  z-index: 1;
  pointer-events: none;
  background-image: url("/assets/slide-1/background.png");
  background-size: cover;
  background-position: center center;
  opacity: 1;
